...
class HouseCardListed extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Link to={`/edit/${house.id}`} className="house-card">
...
export default connect(mapStateToProps, { favoriteHouse, unfavoriteHouse, getHouses, getFavorites })(HouseCardListed);
